pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/subletb/225-lab3-9.git' //<-----change this to match this new repository!
        KUBECONFIG = credentials('subletb-225')                           //<-----change this to match your kubernetes credentials (MiamiID-225)! 
    }
